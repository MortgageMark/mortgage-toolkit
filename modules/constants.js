...
// Arch MI — Borrower-Paid Monthly (BPMI) rates
// Source: MCUS-B0283B-AMI-BP-Monthly-FICO-Rate-Card.pdf  Effective: Feb 9, 2026
// FICO buckets: [760, 740, 720, 700, 680, 660, 640, 620]
const PMI_ARCH = {
  // Amortization term > 20 years, fixed-rate
  over20: [
    { ltv: "97-95.01%", cov: 35, rates: [0.0058,0.0070,0.0087,0.0099,0.0121,0.0154,0.0165,0.0186] },
    { ltv: "97-95.01%", cov: 25, rates: [0.0046,0.0058,0.0070,0.0079,0.0098,0.0123,0.0131,0.0150] },
    { ltv: "97-95.01%", cov: 18, rates: [0.0039,0.0051,0.0061,0.0068,0.0085,0.0105,0.0117,0.0127] },
    { ltv: "95-90.01%", cov: 30, rates: [0.0038,0.0053,0.0066,0.0078,0.0096,0.0128,0.0133,0.0142] },
    { ltv: "95-90.01%", cov: 25, rates: [0.0034,0.0048,0.0059,0.0068,0.0087,0.0111,0.0119,0.0125] },
    { ltv: "95-90.01%", cov: 16, rates: [0.0030,0.0040,0.0048,0.0058,0.0072,0.0095,0.0104,0.0113] },
    { ltv: "90-85.01%", cov: 25, rates: [0.0028,0.0038,0.0046,0.0055,0.0065,0.0090,0.0091,0.0094] },
    { ltv: "90-85.01%", cov: 12, rates: [0.0022,0.0027,0.0032,0.0039,0.0046,0.0062,0.0065,0.0073] },
    { ltv: "85% & below", cov: 12, rates: [0.0019,0.0020,0.0023,0.0025,0.0028,0.0038,0.0040,0.0044] },
    { ltv: "85% & below", cov: 6,  rates: [0.0017,0.0019,0.0022,0.0024,0.0027,0.0037,0.0039,0.0042] },
  ],
  // Amortization term ≤ 20 years, fixed-rate (lower rates)
  under20: [
    { ltv: "97-95.01%", cov: 35, rates: [0.0040,0.0053,0.0068,0.0080,0.0101,0.0134,0.0151,0.0172] },
    { ltv: "97-95.01%", cov: 25, rates: [0.0035,0.0045,0.0052,0.0063,0.0078,0.0101,0.0116,0.0132] },
    { ltv: "97-95.01%", cov: 18, rates: [0.0028,0.0035,0.0042,0.0052,0.0063,0.0079,0.0091,0.0105] },
    { ltv: "95-90.01%", cov: 30, rates: [0.0032,0.0043,0.0052,0.0062,0.0077,0.0095,0.0108,0.0127] },
    { ltv: "95-90.01%", cov: 25, rates: [0.0030,0.0039,0.0046,0.0056,0.0067,0.0083,0.0097,0.0114] },
    { ltv: "95-90.01%", cov: 16, rates: [0.0023,0.0029,0.0034,0.0041,0.0050,0.0062,0.0073,0.0084] },
    { ltv: "90-85.01%", cov: 25, rates: [0.0025,0.0031,0.0037,0.0044,0.0051,0.0066,0.0074,0.0089] },
    { ltv: "90-85.01%", cov: 12, rates: [0.0019,0.0021,0.0025,0.0028,0.0033,0.0042,0.0048,0.0056] },
    { ltv: "85% & below", cov: 12, rates: [0.0017,0.0019,0.0023,0.0023,0.0026,0.0032,0.0034,0.0041] },
    { ltv: "85% & below", cov: 6,  rates: [0.0014,0.0016,0.0020,0.0021,0.0021,0.0023,0.0025,0.0028] },
  ],
  adjustments: {
    cashOut:     [0.0018,0.0018,0.0020,0.0025,0.0025,0.0050,0.0050,0.0050],
    secondHome:  [0.0012,0.0012,0.0014,0.0017,0.0020,0.0035,0.0035,0.0035],
    investment:  [0.0034,0.0034,0.0038,0.0047,0.0050,0.0057,0.0057,0.0057],
    highDTI:     [0.0010,0.0010,0.0014,0.0018,0.0021,0.0023,0.0026,0.0027],
  },
...
const TRANSLATIONS_ES = {
  ...
  "Condo":                          "Condominio",
  "State (where the property is located)": "Estado (ubicación del inmueble)",
  "PROPERTY INFO":                  "INFORMACIÓN DE LA PROPIEDAD",
  "PROPERTY TAX":                   "IMPUESTO A LA PROPIEDAD",
  "PROPERTY TAX · Default":         "IMPUESTO A LA PROPIEDAD · Predeterminado",
  "HOME INSURANCE":                 "SEGURO DE HOGAR",
  "APPRECIATION RATE":              "TASA DE APRECIACIÓN",
  "PROJECTED EQUITY CURVE":         "CURVA DE PLUSVALÍA PROYECTADA",
  "BALANCE PAYDOWN":                "AMORTIZACIÓN DEL CAPITAL",
  "PRINCIPAL vs INTEREST BY YEAR":  "CAPITAL vs INTERÉS POR AÑO",
  "CREDIT SCORE":                   "PUNTAJE DE CRÉDITO",
  "Borrower FICO":                  "FICO del Prestatario",
  "Borrower 2 FICO":                "FICO del Co-Prestatario",
  "Appreciation Rate":              "Tasa de Apreciación",
  ...
  "RATE & TERM":                    "TASA Y PLAZO",
  "MI OVERRIDES (LO ONLY)":         "AJUSTES DE MI (SOLO LO)",
  "PMI BY DOWN PAYMENT (INTERNAL)": "PMI POR PAGO INICIAL (INTERNO)",
  "LUMP SUM DETAILS":               "DETALLES DE PAGO ÚNICO",
  "MONTHLY PAYMENT":                "PAGO MENSUAL",
  "SHOULD YOU RECAST?":             "¿DEBERÍA RECALCULAR?",
  "INPUTS":                         "DATOS DE ENTRADA",
  "INCOME & DEBTS":                 "INGRESOS Y DEUDAS",
  "LOAN PARAMETERS":                "PARÁMETROS DEL PRÉSTAMO",
  "RESULTS":                        "RESULTADOS",
  "SALE DETAILS":                   "DETALLES DE VENTA",
  "MORTGAGE PAYOFFS":               "PAGOS DE HIPOTECA",
  "COMMISSION":                     "COMISIÓN",
  "CLOSING COSTS":                  "COSTOS DE CIERRE",
  "NET PROCEEDS":                   "GANANCIAS NETAS",
  "PROPERTY & HOA":                 "PROPIEDAD Y HOA",
  ...
  "Realtor Commission(s)":          "Comisión del Agente",
  "Seller Concessions":             "Concesiones del Vendedor",
  "Annual Property Taxes":          "Impuestos Anuales a la Propiedad",
  "HOA Transfer Fee":               "Tarifa de Transferencia HOA",
  "Annual HOA Dues":                "Cuotas Anuales de HOA",
  "HOA Dues Paid Through":          "Cuotas HOA Pagadas Hasta",
  "1st Mortgage Payoff":            "Pago de 1ra Hipoteca",
  "2nd Mortgage Payoff":            "Pago de 2da Hipoteca",
  "Current Escrow Balance (add-back)": "Saldo de Garantía Actual",
  "Lump Sum Payment":               "Pago de Suma Global",
  "Planned Recast — Month #":       "Recálculo Planificado — Mes #",
